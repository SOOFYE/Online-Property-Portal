      ...
      <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-gray-500 sm:text-xl">
            This stats are for all your Property listings that are currently
            posted.
          </p>
        </div>
        ...
        <div className="mt-8 sm:mt-12">
          <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="flex flex-col rounded-lg border border-gray-100 px-4 py-8 text-center">
              ...
              <ReactTooltip />
              <dd
                data-tip="Profit from all your 'SOLD' Properties"
            ...
            <div className="overflow-hidden overflow-x-auto rounded-lg border border-gray-200">
              <table className="min-w-full divide-y divide-gray-200 text-sm">
                <thead className="bg-gray-100">
                  <tr>
                    <th className="whitespace-nowrap px-5 py-2 text-left font-medium text-gray-900">
                      <div className="flex items-center gap-2">Property ID</div>
                    </th>
                    <th className="whitespace-nowrap px-5 py-2 text-left font-medium text-gray-900">
                    ...
                    <th className="whitespace-nowrap px-13 py-2 text-centre font-medium text-gray-900">
                      Status
                    </th>
                  </tr>
                </thead>
                ...
                <tbody className="divide-y divide-gray-200">
                  {recentListings !== null && recentListings.length !== 0 ? (
                    recentListings.map((value, index) => {
                      return (
                        <tr key={index}>
                          <td className="whitespace-nowrap w-10 px-2 py-2 font-medium text-gray-900">
                            {value.propertyid}
                          </td>
