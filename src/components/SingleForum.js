...
function SingleForum() {
  ...
  const MarkUpVoteComment = async (commentIDD) => {
    ...
    let { data, error } = await supabase.rpc("setupvotecomment", {
          ...
          <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <header class="mb-4 lg:mb-6 not-format">
              ...
              <div class="flex flex-row">
                <div class="flex flex-col mr-5">
                  ...
                  >
                    <svg
                      ...
                      class={
                        upVoted === false
                          ? "w-9 h-9 hover:fill-green-900"
                          : "w-9 h-9 fill-green-900 hover:fill-none"
                      }
                    >
                      <path
                  ...
                  <p className="text-lg text-center font-black">
                    {forumdata[0].uvotes - forumdata[0].dvotes}
                  </p>

                  <button
                    disabled={!loggedIn}
                    type="button"
                    onClick={() => MarkdownVote()}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      ...
                      class={
                        downVoted === false
                          ? "w-9 h-9 hover:fill-red-900"
                          : "w-9 h-9 fill-red-900 hover:fill-none"
                      }
                    >
                      <path
                        stroke-linecap="round"
                ...
                <div class="">
                  <h1 class="break-keep mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">
                    {forumdata[0].question}
                  </h1>
                </div>
              </div>
              ...
              <div class="grid grid-cols-2 gap-4">
                <p className="text-md font-black">
                  Asked on:{" "}
                  {new Date(forumdata[0].date).getDate() +
                    " " +
                    new Date(forumdata[0].date).toLocaleString("default", {
                      month: "short",
                    }) +
                    " " +
                    new Date(forumdata[0].date).getFullYear()}{" "}
                </p>
                <p className="text-md font-black">
                  Asked by: {forumdata[0].fname + " " + forumdata[0].lname}{" "}
                </p>
              </div>
              <hr></hr>
            </header>
            <section class="not-format">
              ...
              {!forumdata[0].closed ? (
                ...
                <div>
                  <p className="text-rose-600 text-2xl font-semibold align-center ">
                    This Question is Closed By the Asker.
                  </p>
                </div>
              )}
                  ...
                  return (
                    <div class="flex flex-row" key={value.comid}>
                      <div class="flex flex-col mr-3 mt-5">
                        <button
                          disabled={!loggedIn}
                          onClick={() => MarkUpVoteComment(value.comid)}
                          type="button"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            stroke="currentColor"
                            class={
                              !userUpvotedComments.find(
                                (e) => e.cid === value.comid
                              )
                                ? "w-6 h-6 hover:fill-green-900"
                                : "w-6 h-6 fill-green-900 hover:fill-none"
                            }
                          >
                            <path
                              stroke-linecap="round"
                        ...
                        <p className="text-md text-center font-black">
                          {value.uvotes - value.dvotes}
                        </p>

                        <button
                          disabled={!loggedIn}
                          onClick={() => MarkDownVoteComment(value.comid)}
                          type="button"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            stroke="currentColor"
                            class={
                              !userDownvotedComments.find(
                                (e) => e.cid === value.comid
                              )
                                ? "w-6 h-6 hover:fill-red-900"
                                : "w-6 h-6 fill-red-900 hover:fill-none"
                            }
                          >
                            <path
                              stroke-linecap="round"
