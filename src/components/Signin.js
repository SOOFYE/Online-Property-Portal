          ...
          <div>
            ...
            <div className="relative">
              ...
              {errorMessage ? (
                <div
                  role="alert"
                  className=" mt-3 col-span-6 mt-8 sm:flex sm:items-center sm:gap-4 rounded border-l-14 border-red-500 bg-red-50 p-4"
                >
                ...
                <div
                  role="alert"
                  className=" mt-3 col-span-6 sm:flex sm:items-center sm:gap-4 rounded border-l-14 border-green-500 bg-green-50 p-4"
                >
