    ...
    <div>
      ...
      {Blogs.map((value) => {
        ...
        return (
          <article
            key={value.blogid}
            class="flex bg-white transition hover:shadow-xl mt-7"
          >
            ...
            <div class="flex flex-1 flex-col justify-between">
              <div class="border-l border-gray-900/10 p-4 sm:border-l-transparent sm:p-6">
                <a href="#">
                  <h3 class="font-bold uppercase text-gray-900 ">
                    {value.title} -{" "}
                    <p className="text-xs italic inline">{value.cat}</p>
                  </h3>
                </a>
                ...
                <p class="mt-5 text-md leading-relaxed text-gray-700 line-clamp-3  truncate">
                  <p className="text-xs italic inline">Content:</p>{" "}
                  {value.content}
                </p>
              </div>
              ...
              <button
                class="ml-5 mb-2 sm:flex sm:items-end sm:justify-start inline"
                onClick={() => deleteBlog(value.blogid)}
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
                  class="w-6 h-6 stroke-white hover:stroke-red-500"
                >
                  <path
