  ...
  return showspam ? (
    ...
    >
      ...
      <div class="items-center sm:flex">
        <span class="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-yellow-500 text-white">
          <svg
        ...
        <p class="mt-3 text-lg font-medium sm:mt-0 sm:ml-3">Report</p>
      </div>

      <p class="mt-4 text-gray-500">
        If you feel this listing doesn't follow our community guidelines or is
        spam, then please report this.
      </p>
      <form onSubmit={handleSubmit}>
        <div class="mt-6 sm:flex">
          ...
          >
            ...
            <option value="Description doesn't match">
              Description doesn't match
            </option>
            <option value="Price seem's too high">Price seem's too high</option>
            <option value="Seems like a fake listing">
              Seems like a fake listing
            </option>
          </select>
        </div>

        <div class="mt-6 sm:flex">
          <button class="inline-block w-full rounded-lg bg-red-500 px-5 py-3 text-center text-sm font-semibold text-white sm:w-auto">
            Report
          </button>
