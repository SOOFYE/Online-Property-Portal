  ...
  return (
    <div>
      <form onSubmit={postQuestion} className="mt-10">
        <label for="title" className="pr-10 text-xl font-medium ">
        ...
        <button class="mt-4  group relative inline-flex items-center overflow-hidden rounded bg-rose-600 px-8 py-3 text-white focus:outline-none focus:ring active:bg-indigo-500">
