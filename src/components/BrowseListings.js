...
function BrowseListings() {
  ...
  return (listings!==undefined )?(
     ...
     <InfiniteScroll
          ...
          next={getData}
          hasMore={hsmre}
          loader={<p className="text-xl font-bold">
              <b>Loading...</b>
            </p>}
            ...
            <Link to={"/SingleListing/"+value.propertyid}><div className="group block overflow-hidden mb-4" key={index}>
                ...
                <div className="overflow-hidden rounded-3xl">
                    ...
                    <div className="relative pt-4">
                        ...
                        <h3 className="truncate hover:whitespace-normal  text-sm group-hover:underline group-hover:underline-offset-4 decoration-solid decoration-indigo-600">
