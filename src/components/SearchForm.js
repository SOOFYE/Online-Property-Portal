      ...
      <div class="absolute bg-black z-10 bg-opacity-90 mx-auto mx-[4rem] w-screen h-max max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-lg text-center">
          ...
          <p class="mt-4 text-white">
            Fill out the form to get filtered results
          </p>
        </div>
            ...
            <div class="relative ">
              ...
              <span class="mt-7 absolute inset-y-0 right-0 grid w-10 place-content-center">
                <button
                  ...
                  class={
                    count > 0
                      ? "rounded-full bg-rose-600 p-0.5 text-white hover:bg-rose-700"
                      : "hidden"
                  }
                  onClick={() => AddTags()}
                >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-3 hover:text-gray-300" viewBox="0 0 20 20"
          ...
          <div>
            <h3 class="mb-2 text-lg font-medium text-white dark:text-white">
              Your Property Type
            </h3>
            ...
            <div className="grid grid-cols-3 mt-2">
              <div class="relative mr-3">
                <input
                  ...
                  class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-black bg-white rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
                />
                <label
                  for="floating_outlined"
                  class="absolute bg-transparent my-2 font-light text-sm text-black dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1"
                >
                  minimum
                </label>
              </div>
          ...
          <div className="my-10">
            <label className="text-white font-bold ">Area (Square Feet)</label>
            <div className="grid grid-cols-3 mt-2">
              <div class="relative mr-3">
                <input
                  required
          ...
          <button class="group relative inline-flex items-center text-center w-full overflow-hidden rounded bg-indigo-600 px-8 py-3 text-white focus:outline-none focus:ring active:bg-indigo-500">
