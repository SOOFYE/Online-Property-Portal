...
<div>
<p className='text-3xl font-extrabold sm:text-4xl mx-2 -mb-1'>Explore more</p>
<div className='grid grid-cols-10 gap-10 overflow-hidden  '>

<Link to="/AreaUnitCoverter" ><div className='mt-4 mx-5 group rounded-2xl bg-green-900 w-[100px] h-[100px] grid col-span-1 place-items-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"  class="w-14 h-14 stroke-green-100">
...
<Link to="/MortageCalculator"><div className='inline mt-4 mx-3 group rounded-2xl bg-teal-900 w-[100px] h-[100px] grid col-span-1  place-items-center  '><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-14 h-14 stroke-teal-100">
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z" />
</svg>
<div className="invisible group-hover:visible rounded-2xl absolute bg-gray-800 opacity-90  grid place-items-center w-[100px] h-[100px] font-bold  text-white text-center ">Mortage Calculator</div>
</div></Link>
