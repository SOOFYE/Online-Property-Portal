    ...
    {listings.map((value,index)=>{
        ...
        return(
            ...
            {(showOptions)?(
                ...
                <ReactTooltip />
                {(value.status==='Active')?(<button data-tip="Mark your property as 'SOLD'" onClick={()=>{submit(value.propertyid)}} class="inline-block rounded-full border border-green-600 bg-green-600 p-1 mr-2  text-white hover:bg-transparent hover:text-green-600 focus:outline-none focus:ring active:text-green-500">
                    ...
                    <button data-tip="Delete this Listing" onClick={()=>{submit2(value.propertyid)}} class="inline-block rounded-full border border-red-600 bg-red-600 p-1 mx-1 text-white hover:bg-transparent hover:text-red-600 focus:outline-none focus:ring active:text-red-500">
